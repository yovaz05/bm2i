 ...
 * VerVentas.java
 *
 * Created on 22 de octubre de 2006, 10:37 PM
 */
...
Lista listaAnteriores;
   ...
   private void setTabla(){
        ...
        // Mensaje.showMensaje(this,"el nombre es "+agencia.getNombre());
         ...
         listaAnteriores =new Lista(new VentaProductos().lista4(hora1,hora2));         
    ...
    private void initComponents() {
        ...
        jLabelCreditopendiente2.setText(" REPORTES DE CABINA DESDE UNA FECHA HASTA OTRA");
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new VentaProductos().lista4(hora1,hora2)),Mapa.MAPAVENTASDIA,true),ReportePrevio.VERVENTAS);
