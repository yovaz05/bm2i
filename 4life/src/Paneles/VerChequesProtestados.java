/*
 * VerChequesProtestados.java
 *
 * Created on 29 de enero de 2007, 10:53 PM
 */
...
public class VerChequesProtestados extends javax.swing.JPanel {
   ...
   private void inicializa(){
    ...
    private void setTabla(){
        ...
        // Mensaje.showMensaje(this,"el nombre es "+agencia.getNombre());
         ...
         listaAnteriores =new Lista(new Cheque().lista6(hora1,hora2, rem));         
    ...
    private void initComponents() {
        ...
        jLabelCreditopendiente2.setText(" REPORTES DE CHEQUES PROTESTADOS DESDE UNA FECHA HASTA OTRA");
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new Cheque().lista6(hora1,hora2, rem)),Mapa.MAPACHEQUE,true),ReportePrevio.CHEQUEPRO);
