/*
 * VerPagosCreditos.java
 *
 * Created on 22 de octubre de 2006, 11:47 PM
 */
...
public class VerPagosCreditos extends javax.swing.JPanel {
...
Boolean bandera=false;
    ...
    /** Creates new form VerPagosCreditos */
    public VerPagosCreditos() {
        initComponents();
        inicializa();
    }
    ...
    private void setTabla(){
        ...
        // Mensaje.showMensaje(this,"el nombre es "+agencia.getNombre());
         ...
         listaAnteriores =new Lista(new CuentasXCobrar().lista4(hora1,hora2));         
    ...
    private void initComponents() {
        ...
        jLabelCreditopendiente2.setText(" REPORTES DE CREDITOS PAGADOS DESDE UNA FECHA HASTA OTRA");
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new CuentasXCobrar().lista4(hora1,hora2)),Mapa.MAPACXC,true),ReportePrevio.COBRARCREDITO);
