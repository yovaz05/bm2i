...
Lista listaAnteriores;
 ...
 private void setTabla(){
        ...
        // Mensaje.showMensaje(this,"el nombre es "+agencia.getNombre());
         ...
         listaAnteriores =new Lista(new Cabinas().lista4(hora1,hora2));         
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new Cabinas().lista4(hora1,hora2)),Mapa.MAPACABINAS,true),ReportePrevio.VERCABINAS);
