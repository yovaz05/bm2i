 ...
 * Verpaquetes.java
 *
 * Created on 21 de octubre de 2006, 10:10 PM
 */
...
public class Verpaquetes extends javax.swing.JPanel {
...
Lista listaAnteriores;
   ...
   private void setTabla(){
        ...
        // Mensaje.showMensaje(this,"el nombre es "+agencia.getNombre());
         ...
         Mapa mapa = new Mapa(listaAnteriores,Mapa.MAPAPAQUETEANULADO,true);
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new Giro().lista20(hora1,hora2,agencia)),Mapa.MAPAPAQUETEANULADO,true),ReportePrevio.PAQUETES);
