/*
 * VergirosRemplazados.java
 *
 * Created on 29 de diciembre de 2006, 16:15
 */
...
public class VergirosRemplazados extends javax.swing.JPanel {
 ...
 private void setTabla(){
         ...
         listaAnteriores =new Lista(new Giro().lista13(hora1,hora2,codigos.getAgencia(),rem));         
    ...
    private void initComponents() {
        ...
        jLabelCreditopendiente2.setText(" TODOS LOS GIROS REMPLAZADOS DESDE UNA FECHA HASTA OTRA");
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        ...
        try {
            ...
            ReportePrevio rp = new ReportePrevio(new Mapa(new Lista(new Giro().lista13(hora1,hora2,codigos.getAgencia(),rem)),Mapa.MAPAGIRO,true),ReportePrevio.REMPLAZA_GIROS);
